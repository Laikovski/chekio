...
For example, we have the following set of numbers: 4, 7, 10, 11, 12, 17, and we need to find the nearest value to the
number 9. If we sort this set in the ascending order, then to the left of number 9 will be number 7 and to the right
...
if __name__ == '__main__':
    print("Example:")
    print(nearest_value({4, 7, 10, 11, 12, 17}, 3))
